...
- ✅ **유해 감지 시 계속 음소거** (자동 복원 없음)
- ✅ 실시간으로 **실행 중인 앱 목록 갱신** (5초마다)
- ✅ **오디오 모니터링은 ROI와 독립적으로 동작** (ROI 선택 없이도 사용 가능)
...
- ✅ 유해 감지 시 계속 음소거 (자동 복원 없음)
- ✅ 오디오 모니터링이 ROI와 독립적으로 동작
- ✅ 시스템 트레이에 오디오 모니터링 상태 표시
...
### 수정된 파일
- ✅ `electron/audio/audioService.ts` - AppVolumeController 통합, ROI와 오디오 모니터링 독립성 구현
- ✅ `electron/main.ts` - ROI 선택/취소 시 오디오 모니터링 자동 시작/중지 제거
- ✅ `electron/tray.ts` - 오디오 모니터링 상태 표시 및 메뉴 통합
- ✅ `electron/audio/appVolumeController.ts` - 유해 감지 시 계속 음소거 구현
...
- [x] Discord는 볼륨 유지 ✅ 완료
- [x] 유해 감지 시 계속 음소거 (자동 복원 없음) ✅ 완료
- [x] 오디오 모니터링이 ROI와 독립적으로 동작 ✅ 완료
- [x] 시스템 트레이에 오디오 모니터링 상태 표시 ✅ 완료
...
### 유해 감지 시 계속 음소거
- ✅ 유해 감지 시 3초 후 자동 복원 기능 제거
- ✅ 유해 감지 시 계속 음소거 상태 유지
- ✅ 사용자가 수동으로 오디오 모니터링을 중지할 때까지 음소거 유지
- ✅ 오디오 모니터링 중지 시 원래 볼륨으로 자동 복원

### 오디오 모니터링과 ROI 독립성
- ✅ 오디오 모니터링이 ROI 영역 캡처와 독립적으로 동작
- ✅ ROI 선택 없이도 오디오 모니터링 시작 가능 (트레이 메뉴 또는 UI)
- ✅ ROI 선택/취소 시 오디오 모니터링은 자동으로 시작/중지되지 않음
- ✅ 사용자가 트레이 메뉴나 UI에서 직접 오디오 모니터링 제어 가능

### 시스템 트레이 통합
- ✅ 트레이 아이콘 색상 변경 기능 추가
  - 초록색 배경 (#10b981): 오디오 모니터링 중
  - 파란색 배경 (#2563eb): 오디오 모니터링 중지
- ✅ 트레이 메뉴에 오디오 모니터링 섹션 추가
  - 상태 표시: "🟢 오디오 모니터링 중" 또는 "⚪ 오디오 모니터링 중지"
  - 시작/중지 버튼: "▶️ 오디오 모니터링 시작" 또는 "⏸️ 오디오 모니터링 중지"
- ✅ 트레이 툴팁에 오디오 모니터링 상태 표시
- ✅ 오디오 모니터링 상태 변경 시 트레이 메뉴 자동 업데이트
