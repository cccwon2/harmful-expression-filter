...
1. **마스터 플랜 확인**
   - @docs/PROJECT_SPEC.md에서 [작업 번호] 요구사항을 다시 확인해.
...
1. **마스터 플랜 확인**
   - @docs/PROJECT_SPEC.md에서 T11 (OCR 서비스) 요구사항을 다시 확인해.
...
- [ ] docs/PROJECT_SPEC.md에서 작업 요구사항 확인
- [ ] docs/INTERFACES.md에서 관련 핵심 파일 확인
...
2. **연결부 파일 무단 수정 금지**
   ...
   - 수정 전에 관련 작업 문서와 docs/INTERFACES.md 확인
...
- [ ] docs/INTERFACES.md 업데이트 (새로운 인터페이스 추가 시)
- [ ] docs/PROJECT_SPEC.md 업데이트 (요구사항 변경 시)
...
1. 해당 작업 문서 확인
2. docs/INTERFACES.md에서 관련 핵심 파일 확인
