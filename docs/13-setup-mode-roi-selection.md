...
- ✅ 사용 안내 메시지 개선 (파란색 배경, 아이콘, 키보드 단축키 표시)
- ✅ 선택 완료 메시지 개선 (초록색 배경, 체크 아이콘, 키보드 단축키 표시)

## ✅ 최근 업데이트 (2024-11-13)

### 오버레이 UI 개선
- ✅ setup 모드에서 사용 안내 메시지 개선
  - 파란색 배경 (rgba(37, 99, 235, 0.95))으로 시각적 가시성 향상
  - 마우스 아이콘 (🖱️) 추가로 직관성 향상
  - 키보드 단축키를 `<kbd>` 태그로 표시하여 명확성 향상
  - 그림자 효과 및 backdropFilter 적용으로 가독성 향상
  - setup 모드에서만 표시되도록 조건 추가
- ✅ 선택 완료 메시지 개선
  - 초록색 배경 (rgba(16, 185, 129, 0.95))으로 완료 상태 명확화
  - 체크 아이콘 (✅) 추가로 성공 상태 표시
  - 키보드 단축키 표시로 다음 동작 안내
  - 사용 안내 메시지와 일관된 디자인 적용
